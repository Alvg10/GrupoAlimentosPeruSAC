 ...
 */
   ...
   public ProductoResponseDTO toDTO(Producto producto) {
    ...
    if(producto.getCategoria() == null){
        throw new BusinessRuleException(String.format(Messages.PRODUCT_NOT_CATEGORY_ASSIGNED, producto.getIdProducto()));
    }
    ...
    if (producto.getTienda() == null) {
        throw new BusinessRuleException(String.format(Messages.PRODUCT_NOT_STORE_ASSIGNED, producto.getIdProducto()));
    }
