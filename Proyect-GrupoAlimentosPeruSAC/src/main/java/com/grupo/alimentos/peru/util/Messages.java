...
public class Messages {
    ...
    public static final String PRODUCT_NOT_CATEGORY_ASSIGNED = "El producto %p no tiene una categoria asignada";

    public static final String PRODUCT_NOT_STORE_ASSIGNED = "El producto %t no tiene una tienda asignada";
